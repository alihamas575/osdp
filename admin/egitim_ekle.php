...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['egitim_ekle'])) {
    ...
    if (empty($egitim_adi)) {
        ...
        try {
            ...
            // Eğitimi ekle
            $stmt = $pdo->prepare("INSERT INTO egitimler (egitim_adi, egitim_suresi, egitim_kaynagi, gecerlilik_suresi, kullanici_id) VALUES (?, ?, ?, ?, ?)");
            $stmt->execute([$egitim_adi, $egitim_suresi, $egitim_kaynagi, $gecerlilik_suresi, $_SESSION['kullanici_id']]);
            
            $egitim_id = $pdo->lastInsertId();
            
            // Eğitim konularını ekle
            ...
            $pdo->commit();
            $basarili_mesaj = "Eğitim başarıyla eklendi!";
...
<head>
    ...
    <title>Yeni Eğitim Ekle - Online Sertifika</title>
    ...
    <div class="row">
        ...
        <main class="col-md-10 p-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Yeni Eğitim Ekle</h1>
                    ...
                    <form method="POST" action="">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="egitim_adi" 
                                           name="egitim_adi" 
                                           value="<?php echo isset($egitim_adi) ? htmlspecialchars($egitim_adi) : ''; ?>" 
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="egitim_suresi" 
                                           name="egitim_suresi" 
                                           value="<?php echo isset($egitim_suresi) ? $egitim_suresi : ''; ?>" 
                                           min="1" 
                                           placeholder="Saat"
                                           required>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="<?php echo isset($gecerlilik_suresi) ? $gecerlilik_suresi : ''; ?>" 
                                           min="1" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" 
                                      ...
                                      name="egitim_kaynagi" 
                                      rows="3" 
                                      placeholder="Eğitim hakkında açıklama, kaynak bilgileri vb."><?php echo isset($egitim_kaynagi) ? htmlspecialchars($egitim_kaynagi) : ''; ?></textarea>
                        </div>
                        ...
                        <div id="egitim-konulari">
                            <!-- Dinamik olarak eklenen konular buraya gelecek -->
                        </div>
                        ...
                        <div class="text-end mt-4">
                            ...
                            <button type="submit" name="egitim_ekle" class="btn btn-success">
                                <i class="fas fa-plus-circle"></i> Eğitimi Ekle
                            </button>
                        </div>
                    </form>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <select class="form-select" name="ana_konu[]" required>
                            ...
                            ${anaKonular.map(konu => `<option value="${konu}">${konu}</option>`).join('')}
                        </select>
                    </div>
                    <div class="col-md-7">
...
// Sayfa yüklendiğinde en az bir konu alanı ekle
